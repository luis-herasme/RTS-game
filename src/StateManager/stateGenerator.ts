...
function setCapitals(
    ...
    playersDescription: Array<PlayerConfiguration>
): Array<Array<BlockData>> {
...
function playersDataFromPlayersDescriptions(
    playersDescriptions: Array<PlayerConfiguration>,
    map: Array<Array<BlockData>>
